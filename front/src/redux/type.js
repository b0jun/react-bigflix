...
// Mylist type
export const CHECK_MYLIST_REQUEST = 'CHECK_MYLIST_REQUEST';
export const CHECK_MYLIST_SUCCESS = 'CHECK_MYLIST_SUCCESS';
export const CHECK_MYLIST_FAILURE = 'CHECK_MYLIST_FAILURE';

export const ADD_MYLIST_REQUEST = 'ADD_MYLIST_REQUEST';
export const ADD_MYLIST_SUCCESS = 'ADD_MYLIST_SUCCESS';
export const ADD_MYLIST_FAILURE = 'ADD_MYLIST_FAILURE';

export const REMOVE_MYLIST_REQUEST = 'REMOVE_MYLIST_REQUEST';
export const REMOVE_MYLIST_SUCCESS = 'REMOVE_MYLIST_SUCCESS';
export const REMOVE_MYLIST_FAILURE = 'REMOVE_MYLIST_FAILURE';

export const LOAD_MYLIST_REQUEST = 'LOAD_MYLIST_REQUEST';
export const LOAD_MYLIST_SUCCESS = 'LOAD_MYLIST_SUCCESS';
export const LOAD_MYLIST_FAILURE = 'LOAD_MYLIST_FAILURE';
